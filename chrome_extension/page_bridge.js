(function () {
  ...
  function getMonacoEditor() {
    ...
    // Path 2: Look for instance on DOM nodes (some versions attach it)
    ...
    for (const el of models) {
      ...
      // Search for the actual instance if it's stored in a property
    ...
    switch (ed.type) {
      ...
      case 'monaco':
        try {
          ...
          console.error(LOG, 'Monaco set failed:', e);
          ed.instance.setValue(text || '');
        }
        return true;
      case 'textarea':
